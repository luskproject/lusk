...
import * as ModuleUnit from "./modulevm.js";
import ConPlus from "../utils/conplus.js";
import * as ResolverUnit from "./resolver.js";
...
// Here's a list of modules that we want to export
// to the transits.
const loadedModules = {
	'lusk:moduleResolver': ResolverUnit,
	'lusk:packageInfo': _package,
	'lusk:vm': ModuleUnit
}
...
export class TransitUnit {
	constructor ( parcelClass ) {
		...
		this.__reqHandle.resolve = ResolverUnit.createResolver( {
